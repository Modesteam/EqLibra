...
class InvestmentFundsControllerTest < ActionController::TestCase
  ...
  test "should create investment_fund" do
    assert_difference('InvestmentFund.count') do
      post :create, investment_fund: { admTax: @investment_fund.admTax, buyDate: @investment_fund.buyDate, capital: @investment_fund.capital, closing_date: @investment_fund.closing_date, closing_price: @investment_fund.closing_price, fundBegin: @investment_fund.fundBegin, manager: @investment_fund.manager, managerContact: @investment_fund.managerContact, name: @investment_fund.name, nfo: @investment_fund.nfo, shareValue: @investment_fund.shareValue, wallet_id: @investment_fund.wallet_id }
    end
  ...
  test "should update investment_fund" do
    patch :update, id: @investment_fund, investment_fund: { admTax: @investment_fund.admTax, buyDate: @investment_fund.buyDate, capital: @investment_fund.capital, closing_date: @investment_fund.closing_date, closing_price: @investment_fund.closing_price, fundBegin: @investment_fund.fundBegin, manager: @investment_fund.manager, managerContact: @investment_fund.managerContact, name: @investment_fund.name, nfo: @investment_fund.nfo, shareValue: @investment_fund.shareValue, wallet_id: @investment_fund.wallet_id }
    assert_redirected_to investment_fund_path(assigns(:investment_fund))
  end
