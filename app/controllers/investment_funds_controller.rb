class InvestmentFundsController < ApplicationController
  ...
  private
    ...
    def investment_fund_params
      params.require(:investment_fund).permit(:name, :buyDate, :admTax, :nfo, :fundBegin, :manager, :managerContact, :shareValue, :capital, :closing_price, :closing_date, :wallet_id)
    end
end
